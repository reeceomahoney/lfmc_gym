...
env = VecEnv(
    joint_pos.RaisimGymEnv(home_path + "/resources", dump(cfg['environment'], Dumper=RoundTripDumper)),
    cfg['environment'])
...
actor_critic_module = modules.get_actor_critic_module_from_config(cfg, env, joint_pos.NormalSampler,
                                                                  device='cpu')
